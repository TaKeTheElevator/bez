 ...
 */
 ...
 class SteamServerElem extends HTMLElement
 {
     ...
     connectedCallback()
     {
         ...
         var playtext = (typeof this.attributes.playtext !== 'undefined') ? this.attributes.playtext.value : '1Join';
         var info = (typeof this.attributes.info !== 'undefined') ? this.attributes.info.value : null;
     ...
     setupWidget(addr, header, width, height, bots, secure_yes, secure_no, hosting_dedicated, hosting_listen, playtext, info, styleBorder, styleShadow, styleColorBackground, styleColorTextBright, styleColorTextDark)
     {
                     ...
                     <div class="steam-server" ` + ((widgetStyle.length > 0) ? widgetStyle: '') + `>
                         ...
                         <div class="steam-server-infos">
                            ...
                            <div class="steam-server-footer">
                                ...
                                <div class="steam-server-separator"></div>
     ...
     changeLang(bots, secure_yes, secure_no, hosting_dedicated, hosting_listen, playtext, info)
    {
 ...
 module.exports = class SteamServer
 {
     ...
     constructor(selector, config = {})
     {
        ...
        var info = (typeof config.info !== 'undefined') ? config.info : 'gay serv';
        ...
        this.elem.setAttribute('info', info);
     ...
     changeLang(bots, secure_yes, secure_no, hosting_dedicated, hosting_listen, playtext, info)
     {
        this.elem.changeLang(bots, secure_yes, secure_no, hosting_dedicated, hosting_listen, playtex, infot);
     }
