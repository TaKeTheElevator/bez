         ...
         req.onreadystatechange = function() {
             if (req.readyState == XMLHttpRequest.DONE) {
                 ...
                 if (json.data.secure) {
                    ...
                    seccoil = '<div class="dot-here"> <div class="dot"></div><div class="pulse"></div></div> '
                 } else {
                    security = secure_no;
                 ...
                 let html = `
                     <div class="steam-server2">
                     <div class="header-in" style="height: 25px;">
                     <div class="header-in-left">
            <a>
              <div style="gap: 5px;" class="header-in-left-text"> <img src="assets/img/icons/server.png" style="width: 23px;">Сервер</div>
            </a>
          </div>
                     </div>
                         ...
                         <div class="steam-server-infos">
                            <div class="steam-server-title">
                                <div class="steam-server-title-left">
                                  <div class="steam-server-title-left-name" ` + ((styleColorTextDark !== null) ? 'style="color: ' + styleColorTextDark + ';"' : '') + `>` + seccoil + ``+ json.data.name + `</div>
                            ...
                            <div class="steam-server-footer">
                                <div class="steam-server-gameinfo" ` + ((styleColorTextDark !== null) ? 'style="color: ' + styleColorTextDark + ';"' : '') + `>
                                    ...
                                    <span class="steam-server-gameinfo-item ` + seccol + `">` + json.data.players + `/` + json.data.max_players + `</span>
                                </div>
            <div class="steam-server-title-right" style="display:none;">
